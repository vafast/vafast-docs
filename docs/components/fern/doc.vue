...
const scalarLight = computed(() => asset('assets/scalar-preview-light.webp'))
const scalarDark = computed(() => asset('assets/scalar-preview-dark.webp'))
</script>
    ...
    <article id="own-doc" ref="scope">
        ...
        <div class="preview">
            <motion.img
                v-bind="flyIn(0.5)"
                loading="lazy"
                class="image image-light"
                :src="scalarLight"
                alt="Scalar documentation generated by Vafast using Vafast Swagger plugin"
            />
            <motion.img
                v-bind="flyIn(0.5)"
                loading="lazy"
                class="image image-dark"
                :src="scalarDark"
                alt="Scalar documentation generated by Vafast using Vafast Swagger plugin"
            />
